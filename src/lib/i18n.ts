...
export const translations = {
  en: {
    ...
    hero_stat2_val: "Custom",
    hero_stat2_label: "Curriculum",
    hero_stat3_val: "Japan",
    hero_stat3_label: "Online / In-Person",
    ...
    prog2_name: "Future Skills Portfolio Class",
    prog2_ages: "Active Flagship · 1-on-1",
  ...
  ja: {
    ...
    hero_stat1_label: "形式",
    hero_stat2_val: "個別設計",
    hero_stat2_label: "カリキュラム",
    hero_stat3_val: "日本",
    hero_stat3_label: "オンライン・対面",
    ...
    prog1_name: "一般英会話クラス",
    prog1_ages: "対象：全年齢",
    prog1_skill1: "スピーキング・リスニング",
    prog1_skill2: "文化・旅行・学校生活",
    prog1_skill3: "自然な自己表現",
    prog2_name: "フューチャースキル・ポートフォリオ",
    prog2_ages: "対象：全年齢（フラッグシップ）",
    prog2_skill1: "リサーチ・AI活用",
    prog2_skill2: "プレゼン・レポート作成",
    prog2_skill3: "実践的なポートフォリオ成果物",
    prog3_name: "フューチャー・コホートクラス",
    prog3_ages: "準備中・ウェイティングリスト",
  ...
  "zh-TW": {
    ...
    prog1_name: "一般英語課程",
    prog1_ages: "開放中 · 1對1",
    prog1_skill1: "會話、聽力與日常對話",
    prog1_skill2: "文化、旅行與學校生活",
    prog1_skill3: "自然的自我表達",
    prog2_name: "未來技能作品集課程",
    prog2_ages: "旗艦課程 · 1對1",
    prog2_skill1: "研究與AI應用",
    prog2_skill2: "簡報與報告製作",
    prog2_skill3: "建立真實作品集",
    prog3_name: "未來小組課程",
    prog3_ages: "準備中 · 候補名單",
  ...
  "zh-CN": {
    ...
    prog1_name: "一般英语课程",
    prog1_ages: "开放中 · 1-on-1",
    prog1_skill1: "会话、听力与日常会话",
    prog1_skill2: "文化、旅行、兴趣与学校生活",
    prog1_skill3: "自然自我表达",
