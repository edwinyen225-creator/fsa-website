...
export type FullScreenFXProps = {
  ...
  ariaLabel?: string;
  /** Rendered once behind all sections, unaffected by GSAP section transitions */
  sharedBackground?: ReactNode;
};
      ...
      >
        ...
        <style>{`
          ...
          .fx-bgs {
            ...
            background: var(--fx-stage-bg); z-index: 1;
          }
          ...
          .fx-footer-title {
            color: var(--fx-text); font-size: clamp(1.6rem, 7vw, 7rem);
          ...
          @media (max-width: 900px) {
            ...
            .fx-center { height: 100vh; width: 100%; }
