...
export default function SignupPage() {
  ...
  return (
    <main className="min-h-screen bg-[#071226] text-white">
      {/* Hero */}
      <section className="relative min-h-[55vh] overflow-hidden bg-gradient-to-b from-[#0B1833] via-[#081327] to-[#071226] px-6 pt-48 pb-24">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <h2 className="font-serif text-4xl sm:text-5xl leading-tight md:text-6xl">{s.ben_h2}</h2>
            ...
            <GlowCard glowColor="gold" customSize className="bg-[#071226] p-10 md:p-14 text-white">
              <div>
